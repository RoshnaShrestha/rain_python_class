...
def explore_location():
   """Explore a random location and find teasures.."""
   locations = ["Mysterious Cave", "Haunted forest", "Deserted Beach", "Ancicent Runis"]
   treasures = ["Golden Crown", "Silver Sword", "Diamond Neacklace", "Ancient Artifact"]
...
def teasure_hunt():
    print("Welcome to Teasure  Hunt!")
    player_name = input("Enter your name : ").strip()

    #Load incentory if it exits
    ...
    while True:
        ...
        if choice == "1":
            teasure = explore_location()
            score += 1
            print(f"You added {teasure} to your incentory!")
        elif choice == "2":
            display_inventory()
        elif choice =="3":
            print(f"\nThanks for playing, {player_name}!")
            print(f"You collected {score} teasures.")
